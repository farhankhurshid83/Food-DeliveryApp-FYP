              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isSentByUser = message['senderId'] == chatController.currentUserId.value;
                    ...
                    Widget messageWidget = Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isSentByUser ? Colors.orange : Colors.grey[200],
                          borderRadius: BorderRadius.only(
                            topLeft: const Radius.circular(12),
                            topRight: const Radius.circular(12),
                            bottomLeft: isSentByUser ? const Radius.circular(12) : const Radius.circular(0),
                            bottomRight: isSentByUser ? const Radius.circular(0) : const Radius.circular(12),
                          ),
                          boxShadow: const [
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.grey[600]),
          ...
          IconButton(
            icon: const Icon(Icons.send, color: Colors.orange, size: 24),
