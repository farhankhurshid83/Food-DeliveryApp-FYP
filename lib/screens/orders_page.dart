...
import 'chats/chat_view_screen.dart';
...
Future<bool> _confirmDeleteOrder(BuildContext context, {bool isAll = false}) async {
return await showDialog<bool>(
context: context,
builder: (context) => AlertDialog(
title: Text(
...
if (confirm) {
try {
await orderController.deleteAllOrders(authController.userId);
Get.snackbar(
"Success",
